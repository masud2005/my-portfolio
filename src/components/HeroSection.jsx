...
import myResume from '/Coming-Soon.pdf'
        ...
        >
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-2 gap-5 mt-10 lg:mt-0">
                ...
                <div className="flex flex-col items-start lg:items-start mb-6 lg:mb-0">
                    <h2 className="text-3xl lg:text-4xl font-medium text-teal-400">Hello, I am</h2>
                    <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold mt-2 text-white">
                        <span>
                            <Typewriter
                                words={['Masud Rana']}
                                loop={true}
                    ...
                    <div className="flex gap-4 mt-6">
                        <a
                            href='https://drive.google.com/file/d/1p4rKjCRKnOKnjTHUKNDGrxnrak59rD0H/view?usp=sharing' // Replace with the path to your resume
                            target='_blank'
                            download
                ...
                <div className="flex justify-center items-center">
                    <img
                        // src="https://via.placeholder.com/300" // Replace with your professional image URL
                        src={profile}
                        alt="Profile"
